...
class _RegisterChildScreenState extends State<RegisterChildScreen> {
  ...
  void _submit() async {
    ...
    try {
      final parentService = Provider.of<AuthService>(context, listen: false);
      await parentService.registerChildren(
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Inscription faite avec succès')),
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Inscrivez votre enfant'),
